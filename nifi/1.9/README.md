...
- A running DC/OS cluster with at least 1 private node.
...
You can also use [Admin Router](https://dcos.io/docs/1.9/development/dcos-integration/#-a-name-adminrouter-a-admin-router) to provide access to the Apache NIfi UI, which is fine for dev/test setups.
...
- **Kafka Brokers** - list of the kafka brokers. If you are using kafka from DC/OS please take a look at the [Kafka Documentation](https://github.com/dcos/examples/tree/master/kafka/1.8#list-kafka-client-endpoints) to check how to determine it.
