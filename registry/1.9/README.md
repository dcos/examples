...
Next, follow our documentation for [mounting NFS volumes](https://dcos.io/docs/1.9/administration/storage/nfs/) to mount your EFS NFS filesystem on each of your DC/OS agents.
